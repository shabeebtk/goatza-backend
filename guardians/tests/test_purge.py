...
from accounts.management.commands.purge_deleted_accounts import (
    ANON_EMAIL_DOMAIN,
    ANON_NAME,
)
from accounts.models import User, UserProfile
from guardians.constants import GUARDIAN_CONSENT_EXPIRY_DAYS
...
class SurvivorsTests(PurgeTestCase):
    ...
    def test_a_resend_restarts_the_clock(self):
        ...
        from guardians.services.consent_service import resend
    ...
    def test_an_approved_minor_is_never_swept(self):
        from guardians.testing import grant_guardian_consent
