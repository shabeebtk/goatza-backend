...
from accounts.throttles import ResendOTPThrottle
...
SENDER = "accounts.views.user_auth_views.send_signup_otp_email"
WELCOME_SENDER = "accounts.views.user_auth_views.send_welcome_email"
