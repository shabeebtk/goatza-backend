...
from apps.accounts.views.user_google_auth_views import (
    GoogleLoginUrlView,
...
from apps.accounts.views.account_deletion_views import (
    AccountDeleteInitiateAPIView,
    AccountDeleteConfirmAPIView
)
from apps.accounts.views.email_change_views import (
    EmailChangeInitiateAPIView,
    EmailChangeConfirmAPIView
)
from apps.accounts.views.phone_change_views import PhoneChangeAPIView
from apps.accounts.views.user_privacy_views import UserPublicProfilePrivacyAPIView
from apps.accounts.views.user_upload_signature_views import GetUploadConfigAPIView
# base url - /user/
