...
class WelcomeEmailTriggerTests(TestCase):
    ...
    @patch("apps.accounts.views.user_auth_views.send_welcome_email")
    ...
    @patch(
        "apps.accounts.views.user_auth_views.send_welcome_email",
...
class PasswordChangedEmailTriggerTests(TestCase):
    ...
    @patch("apps.accounts.views.user_auth_views.send_password_changed_email")
    ...
    @patch(
        "apps.accounts.views.user_auth_views.send_password_changed_email",
        side_effect=RuntimeError("template blew up"),
    )
