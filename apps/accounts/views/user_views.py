...
from apps.accounts.serializers.user_serializers import UserSerializer, UserFullSerializer, UpdateUserMediaSerializer
...
from apps.legal.selectors.acceptance_selectors import (
    get_pending_documents,
    legal_status,
)
from apps.legal.services.acceptance_service import record_acceptance
...
from apps.accounts.serializers.user_update_serilizer import UpdateUserProfileSerializer
from apps.accounts.constants import normalize_country
from apps.accounts.services.age_service import (
    AgeGateError,
    parse_birthdate,
    resolve_country,
    validate_signup_age,
