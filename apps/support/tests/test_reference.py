...
from apps.support.models import ProblemReport
from apps.support.services import problem_report_service
from apps.support.services.problem_report_service import (
    MAX_REFERENCE_ATTEMPTS,
    ProblemReportService,
)
from apps.support.services.reference import (
    REFERENCE_ALPHABET,
    REFERENCE_LENGTH,
    REFERENCE_PREFIX,
    generate_reference,
