...
from apps.sports.models import UserSport

from apps.organization.models import OrganizationSport
from apps.moderation.selectors.blocked_filters import exclude_blocked
from apps.accounts.selectors.visibility_selectors import exclude_inactive_authors
