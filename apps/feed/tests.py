...
from apps.sports.models import Sport, UserSport, SportPosition, UserSportPosition
...
from apps.feed.models import ActorAffinity, PostImpression
from apps.feed.services.feed_services import MAX_POSTS_PER_AUTHOR_PER_PAGE, PAGE_SIZE
from apps.feed.services.ranking_services import FeedRankingService
...
class FeedAffinityTests(FeedTestBase):
    ...
    def test_affinity_contribution_is_capped(self):
        from apps.feed.selectors.feed_selectors import affinities_for
        from apps.feed.services.feed_services import AFFINITY_CAP
