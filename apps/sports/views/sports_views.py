...
from apps.sports.models import Sport, SportAttribute, SportAttributeOption, SportPosition
from apps.sports.serializers.sports_serializers import SportSerializer, SportFullDetailsSerializer
