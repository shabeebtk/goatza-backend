...
from apps.waitlist.models import PlayerSignup
from apps.waitlist.selectors.signup_selectors import (
    display_count,
    display_number,
    is_founding,
)
from apps.waitlist.services.signup_services import PlayerSignupService
...
class ServiceTests(APITestCase):
    ...
    @patch("apps.waitlist.services.signup_services.send_email_async")
    ...
    @override_settings(WAITLIST_NOTIFY_EMAIL="me@example.com")
    @patch(
        "apps.waitlist.services.signup_services.send_email_async",
...
class LocationTests(APITestCase):
    ...
    @patch(
        "apps.waitlist.services.signup_services.LocationService.get_or_create_location",
