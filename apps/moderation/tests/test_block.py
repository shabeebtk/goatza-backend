...
from apps.messaging.consumers.chat_consumers import ChatConsumer
...
from apps.messaging.services.exceptions import BlockedParticipantError
from apps.messaging.services.message_service import MessageService
from apps.moderation.models import Block
from apps.moderation.selectors.blocked_filters import exclude_blocked
from apps.moderation.services.block_guard import BLOCKED_MESSAGE, BlockedError
from apps.moderation.services.block_services import BlockService
...
from apps.posts.models import Comment, Post, PostMention
...
class BlockGuardTests(BlockTestBase):
    ...
    def test_mention_of_blocking_party_is_silently_dropped(self):
        from apps.posts.services.post_content_service import sync_post_content
