...
@patch("apps.recruitments.services.application_service.send_new_applicant_alert_email")
@patch("apps.recruitments.services.application_service.send_application_received_email")
...
class StatusChangeEmailTests(RecruitmentEmailFixture):
    ...
    def setUp(self):
        ...
        with patch(
            "apps.recruitments.services.application_service"
