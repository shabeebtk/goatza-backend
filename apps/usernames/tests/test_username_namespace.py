...
from apps.organization.models import Organization, OrganizationMember, OrganizationProfile
from apps.organization.services.organization_service import OrganizationService
from apps.organization.services.user_organization_services import UserOrganizationService
from apps.posts.services.post_content_service import extract_mention_usernames
from apps.usernames.exceptions import UsernameTaken
from apps.usernames.models import UsernameRegistry
...
class GenerateTests(TestCase):
    ...
    def test_loops_against_the_whole_namespace(self):
        ...
        with patch(
            "apps.usernames.services.username_service.random.randint",
            side_effect=[11, 1234],
        ):
            handle = UsernameService.generate(
...
backfill = import_module(
    "apps.usernames.migrations.0002_backfill_username_registry"
).backfill
